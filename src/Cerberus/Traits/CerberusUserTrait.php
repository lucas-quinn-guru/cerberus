...
trait CerberusUserTrait
{
    ...
    public function cachedRoles()
    {
        ...
        if (Cache::getStore() instanceof TaggableStore) {
            return Cache::tags(Config::get('cerberus.role_user_table'))
    ...
    public function save(array $options = [])
    {
        ...
        if (Cache::getStore() instanceof TaggableStore) {
            Cache::tags(Config::get('cerberus.role_user_table'))->flush();
        }
    ...
    {
        return $this->morphToMany(Config::get('cerberus.role'), "roleable");
    }
