...
use LucasQuinnGuru\Cerberus\Contracts\CerberusUserInterface;
use LucasQuinnGuru\Cerberus\Traits\CerberusUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use LucasQuinnGuru\Cerberus\Permission;
use LucasQuinnGuru\Cerberus\Role;
use Mockery as m;
...
class CerberusUserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRoles()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->once()->with('cerberus.role_user_table')
    ...
    public function testHasRole()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        Config::shouldReceive('get')->with('cerberus.role_user_table')->times(9)->andReturn('role_user');
    ...
    public function testCan()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('cerberus.role_user_table')->times(11)->andReturn('role_user');
    ...
    public function testCanWithPlaceholderSupport()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('cerberus.role_user_table')->times(6)->andReturn('role_user');
    ...
    public function testAbilityShouldReturnBoolean()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('cerberus.role_user_table')->times(32)->andReturn('role_user');
    ...
    public function testAbilityShouldAcceptStrings()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('cerberus.role_user_table')->times(8)->andReturn('role_user');
    ...
    public function testDetachAllRoles()
    {
        ...
        */
        ...
        Config::shouldReceive('get')->with('cerberus.role_user_table')->once()->andReturn('role_user');
    ...
    {
        $permMock = m::mock('LucasQuinnGuru\Cerberus\Permission');
    ...
    {
        $roleMock = m::mock('LucasQuinnGuru\Cerberus\Role');
