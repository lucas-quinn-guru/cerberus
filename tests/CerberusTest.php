...
use LucasQuinnGuru\Cerberus\Cerberus;
...
class CerberusTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testHasRole()
    {
        ...
        */
        $app = new stdClass();
        $cerberus = m::mock('LucasQuinnGuru\Cerberus\Cerberus[user]', [$app]);
    ...
    protected function filterTestExecution($methodTested, $mockedMethod, $returnValue, $filterTest, $abort, $expectedResponse)
    {
        ...
        $app->router = m::mock('Route');
        $cerberus     = m::mock("LucasQuinnGuru\Cerberus\Cerberus[$mockedMethod]", [$app]);
    ...
    public function testFilterGeneratedByRouteNeedsRoleOrPermission(
        ...
        $app         = m::mock('Illuminate\Foundation\Application');
        $app->router = m::mock('Route');
        $cerberus     = m::mock('LucasQuinnGuru\Cerberus\Cerberus[hasRole, can]', [$app]);
