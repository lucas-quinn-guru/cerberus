...
[![License](https://poser.pugx.org/lucas-quinn-guru/cerberus/license.svg)](https://packagist.org/packages/lucas-quinn-guru/cerberus)
[![Total Downloads](https://img.shields.io/packagist/dt/lucas-quinn-guru/cerberis.svg)](https://packagist.org/packages/lucas-quinn-guru/cerberus)
...
If you don't, then try `php artisan vendor:publish` and, if it does not appear, manually copy the `/vendor/lucase-quinn-guru/cerberus/src/config/config.php` file in your config directory and rename it `cerberus.php`.

If your app uses a custom namespace then you'll need to tell cerberus where your `permission` and `role` models are, you can do this by editing the config file in `config/cerberus.php`
